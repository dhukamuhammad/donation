                    ...
                    <div className="absolute inset-0 flex items-center">
                        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
                            <div className="max-w-2xl">
                                ...
                                <p className="text-lg md:text-x text-gray-200 mb-8">
                                    {slide.description}
                                </p>
                                <button className="bg-blue-600 text-white px-5 py-2 rounded-lg hover:bg-blue-700 transition font-medium text-lg shadow-xl hover:shadow-2xl transform hover:scale-105 duration-300">
                                    {slide.buttonText}
                                </button>
                            </div>
                        </div>
